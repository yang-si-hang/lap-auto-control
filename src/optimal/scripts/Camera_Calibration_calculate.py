...
np.savetxt(f'{os.path.dirname(__file__)}/../data/Camera_Calibration/mtx_temp.csv', mtx)
# np.savetxt(f'{path}/dist.csv', dist)
np.savetxt(f'{os.path.dirname(__file__)}/../data/Camera_Calibration/camera_tool_temp.csv', T_tool_camera)