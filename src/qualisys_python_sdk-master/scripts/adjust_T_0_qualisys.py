...
#平移                                                                   x                                       y                               z
adjusted_T_0_qualisys[:3, 3] = adjusted_T_0_qualisys[:3, 3] +0.138*adjusted_T_0_qualisys[:3, 0] +0.01*adjusted_T_0_qualisys[:3, 1] -0.058*adjusted_T_0_qualisys[:3, 2] #+ np.array([-0.0102, -0.0354, -0.0498])
